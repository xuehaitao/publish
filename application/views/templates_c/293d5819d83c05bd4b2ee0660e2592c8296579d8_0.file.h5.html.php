<?php
/* Smarty version 3.1.30-dev/79, created on 2018-04-02 10:10:17
  from "/home/www/test/application/views/templates/h5/h5.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/79',
  'unifunc' => 'content_5ac19109346de9_22861864',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '293d5819d83c05bd4b2ee0660e2592c8296579d8' => 
    array (
      0 => '/home/www/test/application/views/templates/h5/h5.html',
      1 => 1522635014,
      2 => 'file',
    ),
  ),
...
function content_5ac19109346de9_22861864 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div id="wrap" class="wrap">
            <div class="top-nav">
                <ul class="nav-layout nav-head" id="nav-head">
                    <li class="nav-list active">基本信息</li>
                    <li class="nav-list">安全保障</li>
                    <li class="nav-list">运营报告</li>
                    <li class="nav-list">风险管理</li>
                    <li class="nav-list">监管制度</li>
                    <li class="nav-list">帮助中心</li>
                    <li class="nav-list">活动信息</li>
                    <li class="nav-list">联系我们</li>
                    <li class="nav-list">招贤纳士</li>
                    <li class="nav-list">信披声明</li>
                </ul>
            </div>
                ...
                <div class="info_tab_two">
                    ...
                    <div class="content_2">
                        ...
                        <span id="zhizhao" style="display:none;">
                            layer.open({content:'<div class="zzmask"></div><div class="zzmask_t">营业执照，组织机构代码证，税务登<br>记证，社会保险登记证，统计<br>登记证（五证合一）</div>',style:'background-color:transparent;color:#fff;border:none;',time: 0});
                        </span>
                        <span id="cert" style="display:none;">
                            layer.open({content:'<div class="cermask"></div><div class="cermask_t">开户许可证</div>',style:'background-color:transparent;color:#fff;border:none;',time: 0});
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="info_tab_three">
                    ...
                    <div class="content_3">
                        <ul class="content_3_table">
                            ...
                            <li class="content_3_table_cell cl 12">管理团队</li><li class="content_3_table_cell cr"><p>董事：陈立 ; 监事：张亮 ;<br>财务负责人：蔡艳雯 ;<br>风控负责人：林文斐 ;<br>技术负责人：薛海涛 ;</p></li>
                    ...
                    <div class="content_5">
                        <div class="content_5_tab">
                            ...
                            <div id="tab5_1" class="tab_5_tab_content">
                                <p>
                                    北京市朝阳区国有资本经营管理中心:成立于2009年，注册资本金100亿元，是朝阳区国资委直属的全民所有制企业，定位为区属国有资本投融资平台。<br>国资中心致力于打造服务区域发展和社会公共项目建设的融资平台、推动关键产业发展的产业投资平台、支持新项目新企业的创业投资平台和加快国有经济优化调整的国有资产管理平台，通过专业化和市场化的运作，充分发挥国有资本的作用和影响力，不断提升企业规模和效益，促进区域经济发展。
                                </p>
                            </div>
                            <div id="tab5_2" class="tab_5_tab_content" style="display:none;">
                                <p>
                                    中环国投环保集团有限公司:中环国投控股有限公司的子公司，注册资本金5100万元，专注于环保行业信息化的咨询、设计、开发和实施服务的高科技软件企业。<br>公司总部位于北京中环国投大厦，在北京上地科技园和烟台两地建有研发基地，在广州、济南、南宁和南昌等地建有本地化实施服务团队。公司的宗旨是以科技为本，铸诚信之根，促环境发展，创绿色家园。
                                </p>
                            </div>
                            <div id="tab5_3" class="tab_5_tab_content" style="display:none;">
                                <p>
                                    北京冠天下商贸有限责任公司:成立于1981年，注册资本金4000万元，职工人数1000人以上。<br>公司尊崇“踏实、拼搏、责任”的企业精神，并以诚信、共赢、开创经营理念，创造良好的企业环境，以全新的管理模式，完善的技术，周到的服务，卓越的品质为生存根本，始终坚持用户至上、用心服务于客户，坚持用自己的服务去打动客户。
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div id="info_tab10" class="info_tab10">
                <div class="info_tab_ten">
                    ...
                    <div class="content_10">
                        <p>累计借贷金额:<span>1,404,056,496.17 元</span></p>
                        <p>累计借贷笔数:<span>2914 笔</span></p>
                        <p>借贷余额:<span>530,415,881.87 元</span></p>
                        <p>借贷余额笔数:<span>958 笔</span></p>
                        <p>累计出借人数量:<span>5907 人</span></p>
                        <p>累计借款人数量:<span>85 人</span></p>
                        <p>当期出借人数量:<span>2224 人</span></p>
                        <p>当期借款人数量:<span>6 人</span></p>
                        <p>前十大借款人待还金额占比:<span>85.03 %</span></p>
                        <p>最大单一借款人待还金额占比:<span>23.57 %</span></p>
                        <p>关联关系借款余额:<span>0</span></p>
                        <p>关联关系借款余额笔数:<span>0</span></p>
                        <p>逾期金额及笔数:<span>0</span></p>
                        <p>逾期90天（不含）以上金额:<span>0</span></p>
                        <p>逾期90天（不含）以上笔数:<span>0</span></p>
                        <p>累计代偿金额及笔数:<span>0</span></p>
                    </div>
                    <div class="content_10_bottom">
                        <ul id="content_10_line">
                            <li class="left"></li>
                            <li class="right"><span>&nbsp;&nbsp;数据截至2018年2月28日&nbsp;&nbsp;</span></li>
                        </ul>
                    </div>
                </div>
            </div>
...
>
            $(".tab_5_tab a").click(function() {
                ...
                if($(this).parent().index()===0){$(this).parent().next().next().css("border-left","0.01rem solid #666");$(this).parent().next().css("border-right","none");$(this).parent().css("border-right","0.01rem solid #e84141");}
                if($(this).parent().index()===1){$(this).parent().next().css("border-left","none");$(this).parent().prev().css("border-right","none");$(this).parent().css("border-right","0.01rem solid #e84141");}
                if($(this).parent().index()===2){$(this).parent().prev().prev().css("border-right","0.01rem solid #666");$(this).parent().prev().css("border-right","none");$(this).parent().css("border-left","0.01rem solid #e84141");}
                return false;
            });        
        <?php echo '</script'; ?>
>
