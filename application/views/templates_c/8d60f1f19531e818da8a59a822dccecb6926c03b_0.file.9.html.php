<?php
/* Smarty version 3.1.30-dev/79, created on 2018-03-27 18:41:30
  from "/home/www/test/application/views/templates/about/9.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30-dev/79',
  'unifunc' => 'content_5aba1fda3201a9_28171053',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8d60f1f19531e818da8a59a822dccecb6926c03b' => 
    array (
      0 => '/home/www/test/application/views/templates/about/9.html',
      1 => 1522058058,
      2 => 'file',
    ),
  ),
...
function content_5aba1fda3201a9_28171053 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<div id="accordion" class="pg-help-list-box help-list-invest">
			<ul class="question">
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">网络借贷资金存管业务指引</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.cbrc.gov.cn/govView_4201EF03472544038242EED1878597CB.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">网络借贷信息中介机构业务活动信息披露指引</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.cbrc.gov.cn/govView_C8D68D4C980A4410B9F4E21BA593B4F2.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">网络借贷信息中介业务活动管理暂行办法</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.cbrc.gov.cn/govView_37D312933F1A4CECBC18F9A96293F450.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">网络借贷信息中介机构备案登记管理指引</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.cbrc.gov.cn/govView_E7B94B41E8C340E4833472632308AEC5.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">北京市网络借贷信息中介机构备案登记管理办法（试行）（征求意见稿）</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.bjjrj.gov.cn/tztg/c44-a1889.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">关于做好P2P网络借贷风险专项整治整改验收工作的通知</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.sohu.com/a/211166474_99975911" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">关于进一步加强校园贷规范管理工作的通知</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.gov.cn/xinwen/2017-06/28/content_5206542.htm" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
				<div style="margin:20px 0 0;">
					<div style="font-size:24px;display:inline-block;">关于整顿“现金贷”业务的通知</div>
					<div style="font-size:14px;display:inline-block;margin-left:10px;"><a href="http://www.p2pfy.com/20171203/3383.html" target="_blank">点击查阅详情</a></div>
				</div>
				<div style="width:100%;height:0;margin-top:20px;border-top:1px solid #d9d9d9;"></div>
			</ul>
		</div>
